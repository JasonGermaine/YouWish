...
public class User
{
	...
	public ArrayList<String> getFollowing() 
	{
		...
		String mArray[] = mFollowing.split(" ");
		//list.add();
		ArrayList<String> mList = new ArrayList<String>();
		for(int i = 0; i < mArray.length; i++)
		{
			if(!mArray[i].equals(" ") && !mArray[i].equals("") && mArray[i] != null)
			{
				mList.add(mArray[i]);
			}
		}
	...
	{ 
		...
		for(int i = 0; i < following.size(); i++)
		{
			...
			{
				update += " " + following.get(i);
			}
		}
		
		this.mFollowing = update; 
	}
	
	@com.google.gson.annotations.SerializedName("profile_pic")
	private String mProfilePic;
	public String getProfilePic() { return mProfilePic; }
	public void setProfilePic(String ProfilePic) { this.mProfilePic = ProfilePic; }

	
	public User(String email, String password, String fName, String lName, String gender, String DOB, String bio, String pic, String following)
	{
		this.mEmail = email;
		this.mGender = gender;
		setPassword(password);
