...
import com.example.youwish.util.RecoveryManager;
...
public class LoginActivity extends FragmentActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		findViewById(R.id.sign_in_button).setOnClickListener(new View.OnClickListener()
		{
			...
			{
				if (((YouWishApplication) getApplication()).verifyConnection(LoginActivity.this) == true)
				{
	...
	private void recoveryEmail()
	{
		...
		View promptsView = li.inflate(R.layout.dialog_password_recovery, null);
